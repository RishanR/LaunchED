...
import Switch1 from "../components/Switch1.js";
import Press from "../components/Picker.js";
  ...
  render() {
    return (
      <View style={{ backgroundColor: "#303030" }}>
        //#303030
        <Header
          outerContainerStyles={{ backgroundColor: "#0c98da" }}
          innerContainerStyles={{ backgroundColor: "#0c98da" }}
        ...
        <View style={{width: 278, marginBottom: 15}}>
        <Text
          h4
          style={{
            color: "white",
        ...
        <View style={{marginLeft: 330, paddingVertical: 26, marginTop: -120}}>
        <Entypo name="chevron-right" size={48} color="#09a4ed"  />
        </View>
